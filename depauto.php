					...
					<div class="box-content">
						<div class="invoice">
							...
							<div class="invoice-from">
								<strong>HOD: SNM BASIL</strong>
								<address>
									Street Address <br>
									City, ST ZIP Code <br>
									<abbr title="Phone">Phone:</abbr> (125) 358123-581 <br>
									<abbr title="Fax">Email :</abbr> (125) 251656-222 
								</address>
					...
					<div class="box">
						...
						<div class="box-content">
							<div class="info">
										...
										<div class="detail">
											<span class="sender">
												<strong>HOD </strong> says:
											</span>
											<span class="time">15 minutes ago Date:</span>
                                                                                       
										</div>
                                                                                 <br>
										<div class="message">
											<p>Lab Exam On March 22 :2013  </p>
										</div>
									</div>
