										...
										<table class='table table-striped table-bordered'>
											...
											<tbody>
                                                            ...
                                                            <?php
                                                             ...
                                                             {
                                                                 $vid=$_GET["id"];
                                                                 $sql="UPDATE `files` SET `status`=1 WHERE `id`=$vid";
                                                                 $conn->query($sql);
                                                                 echo '<script>alert("Verified succesfully...!")</script> ';
                                                             }
                                                             $sql="SELECT * FROM files where status=0 order by id desc ";
													...
													';//<td> '; echo $row["name"];echo' </td>
                                                                                                        ...
                                                                                                        echo '<td><a href="verifyfile.php?id='.$row["id"].'"><button class="btn btn-primary">Verify</button></a>  ';//     <button class="btn btn-danger">Block</button>  
                                                                                                        echo '<a href="uploads/'.$row["filename"].'"><button class="btn btn-success">Download</button></a></td>
