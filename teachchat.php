                ...
                <div class="navi">
                    <ul class='main-nav'>
                        ...
                        while ($row = mysql_fetch_array($result)) {
                            ...
                            $bc = $brow["id"];
                            if ($bc == null) {
                                echo ' <li> <a href="chat_update.php?id=' . $row['addno'] . '" class=\'light\'>
                        ...
                        while ($row = mysql_fetch_array($result)) {
                            ...
                            $bc = $brow["id"];
                            if ($bc == null) {
                                echo ' <li> <a href="chat_update.php?id=' . $row['id'] . '" class=\'light\'>
                                <div class="ico"><i class="icon-list icon-white"></i></div>
                                ' . $row['name'] . '
...
if ($receiver == 0) {
    ...
    $partner2 = $row['name'];
    if ($partner2 == null) {
        $result = mysql_query("SELECT * FROM `teachers` WHERE `id`='$receiver'");
        $row = mysql_fetch_array($result);
        $partner2 = $row['name'];
    }
