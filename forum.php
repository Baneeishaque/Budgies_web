...
<!-- Mirrored from www.eakroko.de/neat/navigation_hover.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 26 Sep 2015 18:13:12 GMT -->
<head>
<meta charset="utf-8">
<title>Budgies</title>
...
<div class="main">
	...
	<div class="navi">
		<ul class='main-nav'>
			...
			<li>
				<a href="#" class='light toggle-collapsed on-hover'>
		...
		<div class="row-fluid">
			<div class="span12">
					...
					<div class="box-content">
						<img src="images/';echo $row["image"];echo'" alt="">
                                                ';echo $row["description"];echo'
                                                
                                                
					</div>
                                        <a href=""><b>Like</a> 33<img src="/img/sample/w.jpg"> <a href=""><b>Comments</a>  2<img src="/img/sample/w.jpg">
				</div>';
                                            }
                            ?>
